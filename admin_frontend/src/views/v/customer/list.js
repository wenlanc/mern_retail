...
const CustomerList = () => {
  ...
  const fetchItems = (searchText, rowsPerPage, page, order) => {
    ...
    let url = `${process.env.REACT_APP_SERVER_URL}api/customer/list`;
    axios
      .post(url, formData)
      .then((response) => {
    ...
    swalWithBootstrapButtons
      ...
      .then((result) => {
        if (result.isConfirmed) {
          ...
          let url = `${process.env.REACT_APP_SERVER_URL}api/customer/delete/${item._id}`;
          axios
            .get(url)
            .then((response) => {
              console.log(response.data);
                      ...
                      {items.map((item) => (
                        <tr key={item.name}>
                          ...
                          <td>
                            ...
                            <OverlayTrigger
                                placement="top"
                                overlay={<Tooltip>Place Order</Tooltip>}
                              >
                                <Link to={"/customers/order/" + item._id}>
                              ...
                              >
                                <Link to={"/customers/edit/" + item._id}>
