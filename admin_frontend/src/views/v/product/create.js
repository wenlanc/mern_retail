...
const ProductCreate = () => {
  ...
  let handleSubmit = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      setValidated(true);
      const url = `${process.env.REACT_APP_SERVER_URL}api/product/create`;
  ...
  let handleCancel = () => {
    setFormName("");
    setFormDescription("");
    setFormValues([{ size: "", sku: "", cost: "" }]);
    sdsFileInputRef.current.value = null;
    labelFileInputRef.current.value = null;
